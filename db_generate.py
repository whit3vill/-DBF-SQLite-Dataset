...
def db_generate(db_name, journal_mode, data):
...
def data_rand_generate():
    ...
    Media = blob_rand_generate(2) # seed = 1
...
#cur.execute("INSERT INTO stocks VALUES('2005-01-05','BUY','RHAT',100,35.14)")
...
#    print(data)
    db_generate('SFT-01-UTF8-WAL.sqlite', 'wal', data)
#    read_db()
